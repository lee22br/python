...
def tag_special_ingredients(dish):
    ...
    if SPECIAL_INGREDIENTS.intersection(set(ingredients)):
        allergens = SPECIAL_INGREDIENTS.intersection(set(ingredients))
        result = (dish_name, allergens)
    return result
...
def separate_appetizers(dishes, appetizers):
    ...
    """
    result = list(set(dishes) - set(appetizers))
    return result
...
def singleton_ingredients(dishes, intersection):
    ...
    all_ingredients = set()
    for item in dishes:
        all_ingredients = all_ingredients.symmetric_difference(item)
    result = all_ingredients - intersection
    return result
